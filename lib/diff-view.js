	...
	renderButtons (loading) {
		return (
			<div className='diff-view-buttons btn-group'>
				<button className='btn btn-success icon icon-sync' disabled={loading} on={{ click: this.refresh }}> Refresh</button>
				<button className='btn btn-info icon icon-cloud-download' disabled={loading} on={{ click: this.restore }}> Restore</button>
				<button className='btn btn-error icon icon-cloud-upload' disabled={loading} on={{ click: this.backup }}> Backup</button>
				<button className='btn btn-warning icon icon-link-external' on={{ click: this.viewBackup }}> View Backup</button>
			</div>
		)
	}
